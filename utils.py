...
def create_parser():
    ...
    parser.add_argument('--config_file',default='experiments/parameters_bitcoin_alpha_linkpred_meta_gcn.yaml', type=argparse.FileType(mode='r'), help='optional, yaml file containing parameters to be used, overrides command line parameters')
    return parser
